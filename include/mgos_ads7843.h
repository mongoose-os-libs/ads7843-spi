...
void set_min_landscape_height_cal_value(uint16_t _min_landscape_height_cal_value);
void set_max_landscape_width_cal_value(uint16_t _min_landscape_width_cal_value);
void set_max_landscape_height_cal_value(uint16_t _min_landscape_height_cal_value);
